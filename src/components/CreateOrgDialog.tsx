    ...
    <Dialog>
      ...
      <DialogContent>
        <form action={action} className="grid gap-5">
          <DialogHeader>
            <DialogTitle>ワークスペースを作成する</DialogTitle>
            <DialogDescription>会社やチームの単位です。作成したあと、招待リンクでメンバーを招待できます。</DialogDescription>
          </DialogHeader>
          <div className="grid gap-2">
            <Label htmlFor="org-name">ワークスペース名</Label>
