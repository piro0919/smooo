...
- 誰かの問いにそのまま答えただけの投稿で、問いを出した人が決めることも、返すべき問いも残っていないなら、
  問いを出した人は選ばない。お礼や了解はリアクションで足りる。
  答えに候補や条件が含まれていて、まだ決めることが残っているなら選ぶ
...
const LIMITS: Record<Autonomy, string> = {
  careful: `答えてよいのは、「覚えていること」にこの問いへの答えがそのまま書いてある事実だけです。
新しい約束、引き受け、日時の確定は、覚えていることに手がかりがあっても、必ず本人に聞きます。
「基本的に引き受ける」「午後なら空いている」のような傾向から、具体的な約束を組み立ててはいけません。
少しでも解釈や推測が要るなら、本人に聞きます。`,
  standard: `答えてよいのは、「覚えていること」と会話から確実に言えることだけです。
本人の予定、意向、判断、新しい約束が要るのに、覚えていることから言えなければ、本人に聞きます。
「基本的に引き受ける」のような傾向だけを根拠に、具体的な依頼を引き受けてはいけません。
推測で答えてはいけません。`,
  trusting: `「覚えていること」と会話から無理なく判断できるなら、本人に聞かずに答えます。
ランチや雑談の誘い、議事録や司会のような軽い依頼、空いている時間帯の打ち合わせのように、
ふだんの仕事で本人がまず断らないことは、覚えていることに手がかりがなくても受けてかまいません。
避けたい時間帯と重なるなら、断るか、覚えていることをもとに別の時間を出して返します。
お金、契約、人事、休暇、大きな約束のように重い判断が要るときと、手がかりがまったくないときだけ本人に聞きます。
「上長に確認してから決める」と覚えているなら、依頼の引き受けは本人に聞きます。`,
};
